...
obs: so implementamos a funcao avaliacao a priori
...
(************************************************************************)
(******     funcoes para a substituicao dos ids nas expressoes     ******)
...
(* testes da substituicao dos ids em expressoes *)
...
(*****************************************************************************)
(******  bateria de testes (todas as linhas abaixo devem retornar true) ******)
